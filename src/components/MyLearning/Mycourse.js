export default function Mycourse(){
    return (
        <div className="my-10 mx-[5%] flex flex-wrap justify-between">
            <div className="w-[29%] px-4 py-6 mt-2 rounded-xl shadow-xl shadow-[#D9D9D9]">
                <div>
            ...
            <div className="w-[29%] px-4 py-6 mt-2 rounded-xl shadow-xl shadow-[#D9D9D9]">
                <div>
                    <img className="w-full h-full" src="../img/MCimg2.png"/>
                </div>
                <div className="space-y-3 mt-2">
                    <p className="font-pop font-semibold text-[18px]">AWS Certified Solutions Architect</p>
                    <div className=" flex items-center">
            ...
            <div className="w-[29%] px-4 py-6 mt-2 rounded-xl shadow-xl shadow-[#D9D9D9]">
                <div>
                    <img className="w-full h-full" src="../img/MCimg3.png"/>
                </div>
                <div className="space-y-3 mt-2">
                    <p className="font-pop font-semibold text-[18px]">AWS Certified Solutions Architect</p>
                    <div className=" flex items-center">
